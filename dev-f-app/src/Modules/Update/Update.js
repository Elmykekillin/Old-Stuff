...
const handleIsAliveChange= event => {
 ...
 const handleSumbit= async(e)=>{
     e.preventDefault()
     try{
        await axios.put(`https://goodreads-devf-aaron.herokuapp.com/api/v1/authors/${id}`,jsonToSend).then(res => setData(res.data))
...
<input type="number" id="id" placeholder="ID" onChange={handleIdChange}></input>
